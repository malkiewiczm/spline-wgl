...
OBJECTS :=  ./build/camera.o ./build/cart.o ./build/common.o ./build/key.o ./build/main.o ./build/mouse.o ./build/shader.o ./build/spline.o ./build/vao.o
...
build/mouse.o: src/mouse.cpp src/mouse.hpp
