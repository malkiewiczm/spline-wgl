...
OBJECTS :=  ./build/camera.o ./build/cart.o ./build/cart_obj.o ./build/common.o ./build/key.o ./build/main.o ./build/mouse.o ./build/obj_loader.o ./build/shader.o ./build/spline.o ./build/vao.o
